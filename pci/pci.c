...
//I don't know how much memory it need now. just guess 1Mbyte
#define CYGHWR_INTEL_I82559_PCI_MEM_MAP_SIZE 0x100000 
...
inline void OUTB(cyg_uint8 value, cyg_uint32 io_address)
{
    HAL_WRITE_UINT8( io_address, value);
}

inline void OUTW(cyg_uint16 value, cyg_uint32 io_address)
{
    HAL_WRITE_UINT16( io_address, (((value & 0xff) << 8) | ((value & 0xff00) >> 8)) );
}

inline void OUTL(cyg_uint32 value, cyg_uint32 io_address)
{
    HAL_WRITE_UINT32( io_address,
                      ((((value) & 0xff) << 24) | (((value) & 0xff00) << 8) | (((value) & 0xff0000) >> 8) | (((value) >> 24) & 0xff)) );
}

inline cyg_uint8 INB(cyg_uint32 io_address)
{   
    cyg_uint8 d;
...
inline cyg_uint16 INW(cyg_uint32 io_address)
{
    cyg_uint16 d;
...
inline cyg_uint32 INL(cyg_uint32 io_address)
{
    cyg_uint32 d;
