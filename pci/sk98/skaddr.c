...
static const char SysKonnectFileId[] =
	"@(#) $Id: skaddr.c,v 1.2 2004/05/18 01:11:10 snow Exp $ (C) Marvell.";
...
#if 0 //snowel:read mac address from flash
		InAddr = (SK_U8 *) &pAC->Addr.Net[0].PermanentMacAddress.a[0];
		memcpy(InAddr,pAC->p_88e8003->mac_address,6);
#endif
