...
extern SK_U32		SkOsGetTime(SK_AC*);
...
struct s_DrvRlmtMbuf {
	...
	IOB	*pOs;		/* Pointer to message block */
};
...
struct s_RxD {
	...
	IOB	*pMBuf;		/* Pointer to Linux' socket buffer */
};
...
struct s_TxPort {
	/* the transmit descriptor rings */
        SK_U8 *	        pTxDescrRing;	/* descriptor area memory */
  ...
  //	spinlock_t	TxDesRingLock;	/* serialize descriptor accesses */
	SK_U8 *		HwAddr;		/* bmu registers address */
...
struct s_RxPort {
	...
	SK_U8 *		pRxDescrRing;	/* descriptor area memory */
...
typedef struct giga_dev gigaDev;
...
struct s_AC  {
  ...
  //	struct SK_NET_DEVICE	*dev[2];	/* pointer to device struct */
	...
	SK_U8 *		pDescrMem;	/* Pointer to the descriptor area */
	SK_U8 *		pDescrMemDMA;	/* PCI DMA address of area */
