...
#else
#define SK_OUT8(b,a,v)		OUTB((v), ((b)+(a)))	
#define SK_OUT16(b,a,v)		OUTW((v), ((b)+(a)))
#define SK_OUT32(b,a,v)		OUTL((v), ((b)+(a)))
#define SK_IN8(b,a,pv)		(*(pv) = INB((b)+(a)))
#define SK_IN16(b,a,pv)		(*(pv) = INW((b)+(a)))
#define SK_IN32(b,a,pv)		(*(pv) = INL((b)+(a)))
#endif
...
#ifdef DEBUG
#define SK_DBG_PRINTF		diag_printf
