...
static const char SysKonnectFileId[] =
	"@(#) $Id: skrlmt.c,v 1.4 2004/05/18 01:11:10 snow Exp $ (C) Marvell.";
#endif	/* !defined(lint) */
...
#else
	    VirtualMacAddress.a[j] = pAC->p_88e8003->mac_address[j];
#endif
...
#else
	    PhysicalAMacAddress.a[j] = pAC->p_88e8003->mac_address[j];
#endif
...
#endif
	//snowel
	//	diag_printf("in SkRlmtBuildPacket:PortNumber=%d\n",PortNumber);
...
SK_EVPARA	Para)	/* SK_U32 PortNumber; SK_U32 Undefined */
{
	...
	if ((pRPort->Net->RlmtMode & SK_RLMT_TRANSPARENT) == 0 &&
	  ...
	  //diag_printf("Para.pParaPtr=%08x,line:%d\n",Para2.pParaPtr,__LINE__);
	  //diag_printf("EvPut=%08x,EvGet=%08x\n",pAC->Event.EvPut,pAC->Event.EvGet);
