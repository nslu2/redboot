...
plf_hardware_init(void)
{
    ...
    HAL_GPIO_OUTPUT_ENABLE(GPIO_LED_STATUS);
    HAL_GPIO_OUTPUT_SET(GPIO_LED_READY);
    HAL_GPIO_OUTPUT_ENABLE(GPIO_LED_READY);

    HAL_GPIO_OUTPUT_DISABLE(GPIO_PUSHBUTTON);
#endif

    *IXP425_EXP_CS4 = (EXP_ADDR_T(3) | EXP_SETUP_T(3) | EXP_STROBE_T(15) | EXP_HOLD_T(3) | \
		       EXP_RECOVERY_T(15) | EXP_SZ_512 | EXP_WR_EN | EXP_CS_EN | EXP_BYTE_EN);
    ...
    *IXP425_EXP_CS7 = (EXP_ADDR_T(3) | EXP_SETUP_T(3) | EXP_STROBE_T(15) | EXP_HOLD_T(3) | \
		       EXP_RECOVERY_T(15) | EXP_SZ_512 | EXP_MUX_EN | EXP_WR_EN | EXP_CS_EN);
...
char npe_mac[2][6]={{0x00,0xc0,0x02,0x01,0x01,0x02},{0x00,0xc0,0x02,0x01,0x01,0x03}};
...
cyghal_get_npe_esa(int port, cyg_uint8 *buf)
{
    ...
    memcpy(buf,(unsigned char *)0x5003ffb0,6);
    if (buf[0] == 0xff && buf[1] == 0xff && buf[2] == 0xff &&
        buf[3] == 0xff && buf[4] == 0xff && buf[5] == 0xff)
      memcpy(buf,npe_mac[port],6);
    else
