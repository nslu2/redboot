...
*/
extern unsigned long sys_times_ms(void);
#define SYSTEMTIME_MS   sys_times_ms()
...
/* protocol handler */
typedef void (*pkt_handler_t)(IOB *psIOB, eth_header_t *eth_hdr);

/* ICMP fielder */
typedef void (*icmp_handler_t)(IOB *psIOB, ip_route_t *src_route);
...
#endif
extern ip_addr_t __local_tftp_server_ip_addr;
 ...
 */
extern void __arp_handler(IOB *psIOB);
 ...
 */
extern void __ip_handler(IOB *psIOB, enet_addr_t *src_enet_addr);
 ...
 */
extern int __ip_send(IOB *psIOB, int protocol, ip_route_t *dest);
 ...
 */
extern void __icmp_handler(IOB *psIOB, ip_route_t *r);
 ...
 */
extern void __udp_handler(IOB *psIOB, ip_route_t *r);
