...
#define IXDP425_LED_DATA                   REG16(0, 0x54000000)
...
// CS1 (flash optimum timing)
#define IXP425_EXP_CS1_INIT \
 (EXP_ADDR_T(3) | EXP_SETUP_T(3) | EXP_STROBE_T(15) | EXP_HOLD_T(3) | \
  EXP_RECOVERY_T(15) | EXP_SZ_16M | EXP_WR_EN | EXP_BYTE_RD16 | EXP_CS_EN)

#define IXP425_EXP_CS4_INIT \
 (EXP_ADDR_T(3) | EXP_SETUP_T(3) | EXP_STROBE_T(15) | EXP_HOLD_T(3) | \
  EXP_RECOVERY_T(15) | EXP_SZ_512 | EXP_WR_EN | EXP_CS_EN )

#define IXP425_SDRAM_CONFIG_INIT  (SDRAM_CONFIG_CAS_3 | SDRAM_CONFIG_2x16Mx16)
//#define IXP425_SDRAM_CONFIG_INIT  (SDRAM_CONFIG_CAS_3 | SDRAM_CONFIG_4x16Mx16)
//#define IXP425_SDRAM_REFRESH_CNT  0x81A   //grg config
#define IXP425_SDRAM_REFRESH_CNT  0x081  //ixdp425 config
...
#if 1
#define GPIO_PUSHBUTTON  12  //EFG120V2 ,Dongle
#else
#define GPIO_PUSHBUTTON  4   //v6 
#endif
#define GPIO_LED_STATUS  0 //hardware error
#define GPIO_LED_READY   1
// ------------------------------------------------------------------------
// No Hex Display
//
#ifdef __ASSEMBLER__
