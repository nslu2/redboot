...
extern int  eth_drv_read(struct eth_drv_sc *sc, char *buf, int len);
extern void eth_drv_write(struct eth_drv_sc *sc, char *buf, int len);
extern int  eth_drv_int_vector(struct eth_drv_sc *sc);
extern void eth_drv_stop(struct eth_drv_sc *sc);
